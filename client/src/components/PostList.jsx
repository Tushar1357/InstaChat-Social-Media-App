...
function PostList() {
  ...
  return (
    ...
    >
      {postList.length === 0? <h1 className="text-white">There are no posts</h1>:postList.map((item) => (
        <div
          className="card m-4"
        ...
        >
          ...
          >
            <img src={`https://dummyjson.com/icon/${item.title}/150`}alt="" width={50} />
          ...
          <div className="card-body bg-dark text-white">
            ...
            <div className="buttons mt-3 d-flex justify-content-evenly p-1">
              <button className="btn btn-primary w-40">
                <BiLike size={20} />{item.reactions.likes} likes
              </button>
              <button className="btn btn-primary w-40">
                <BiShare size={20} />
